...
class V5BackendTest(unittest.TestCase):
    ...
    def test_qq_email_verification_registration_and_free_ai_quota(self):
        verification = self.app.create_email_verification('student@qq.com', deliver=False)
    ...
    def test_alipay_ai_payment_order_supports_custom_amount(self):
        verification = self.app.create_email_verification('buyer@qq.com', deliver=False)
        self.app.register(
            'buyer',
            'StrongPass123',
            'Buyer',
