    ...
    def do_GET(self):
        ...
        try:
            ...
            if parsed.path == '/api/captcha':
                ...
                include_dev_code = os.environ.get('EXAM_DEV_CAPTCHA') == '1' and query.get('dev', ['0'])[0] == '1'
                return self._json(200, APP.create_captcha(include_dev_code=include_dev_code))
    ...
    def do_POST(self):
        ...
        try:
            ...
            if parsed.path == '/api/email/send-code':
                return self._json(200, APP.create_email_verification(
                    body.get('email'),
                    deliver=True,
